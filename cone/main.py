...
#global QR_image 
#QR_image = numpy.zeros((imageHeight,imageWidth,3), numpy.uint8)
...
class StreamProcessor(threading.Thread):
	...
	name = str(time.time())
	cv2.imwrite("real/image"+name+".jpg" , image)	
	...
	cv2.imshow("red",red)
	cv2.imwrite("filtered/image"+name+".jpg" , red)	
        # Find the contours
    ...
    def SetSpeedFromBall(self, ball):
        ...
        if ball:
            ...
            if area < autoMinArea:
                ...
                print 'Close enough'
#		result = qrcode.detect_QR_code(camera,PBR)
#		if result: #adjust it self if turn too much or less
#			
#			
#			
#			
